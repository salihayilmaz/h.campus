...
trainX = pd.read_table('/home/saliha/Desktop/old/tez/UCI HAR Dataset/train/X_train.txt', delim_whitespace=True,header=None)
trainy = pd.read_table('/home/saliha/Desktop/old/tez/UCI HAR Dataset/train/y_train.txt',delim_whitespace=True,header=None)
testX = pd.read_csv("/home/saliha/Desktop/old/tez/UCI HAR Dataset/test/X_test.txt",delim_whitespace=True,header=None)
testy = pd.read_csv('/home/saliha/Desktop/old/tez/UCI HAR Dataset/test/y_test.txt',delim_whitespace=True,header=None)
...
plt.plot(li,tes, label = 'Variance c')
plt.title('PCA  ')
plt.ylabel('Variance d')
